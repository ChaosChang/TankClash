...
public class KinectWrapper
{
	...
	/// <summary>
	///Structs and constants for interfacing C# with the Kinect.dll ，看这情况应该是接口呗
	/// </summary>

    [Flags]
    public enum NuiInitializeFlags : uint//初始化标志位
    {
	...
	public enum NuiErrorCodes : uint//错误码
	{
    ...
    public enum NuiSkeletonPositionIndex : int//骨架节点位置
    {
        HipCenter = 0,
        Spine = 1,
        ShoulderCenter = 2,
